...
const DraftEditorCompositionHandler = {
  ...
  resolveComposition(editor: DraftEditor): void {
    ...
    const editorStateWithUpdatedSelection = isIE ? EditorState.forceSelection(editorState, compositionEndSelectionState) : EditorState.acceptSelection(editorState, compositionEndSelectionState);
